...
type Movie struct {
	...
	Version int32    `json:"version"` // the version number  starts at 1and will be incremented each time the movie information is udpated
}
...
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*Movie, Metadata, error) {
	...
	// when the rows.Next() loops has finished, call rows.Err() to retrieve any error
	// that was encoutered  during the iteration.
